#ifndef _{{cookiecutter.library_name}}_h
#define _{{cookiecutter.library_name}}_h
/*******************************************************************************
   FILE DESCRIPTION
*******************************************************************************/
/*!
@file {{cookiecutter.library_name}}.h
...
#include "{{cookiecutter.library_name}}/{{cookiecutter.library_name}}Exports.h"
/*******************************************************************************
...
class {{cookiecutter.macro_prefix}}_EXPORT {{cookiecutter.library_name}}
{
